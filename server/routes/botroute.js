...
const alternative = ["Same", "Go on...", "Oh?", "I'm listening...", "Bro..."];
...
router.post("/", (req, res) => {
  ...
  //   res.send("i am a server end point");
  if (userInput === "hi" || userInput === "hello") {
    ...
    response =
      "How doth the little crocodil improve his shining tail, and pour the waters of the Nile on every golden scale! How cheerfully he seems to grin, how neatly spreads his claws, and welcomes little fishes in, with gently smiling jaws!";
